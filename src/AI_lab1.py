...
Name: Rojan Dahal
CRN: 018-322
1. Write a program in C/C++/Java to implement DFS/BFS on water jug problem.
Given a 4 - liter jug filled with water & an empty 3 - liter Jug, how can one obtain exactly 2 liters in 4 liters jug. 
There is no measuring mark on any of them.
